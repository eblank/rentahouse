...
(function (a, e) {
    ...
    var f = /[#\/\?@]/g, n = /[#\?]/g, b = /[#@]/g, c = /#/g, p = RegExp("^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"), h = a.Path, q = {
        scheme: 1,
        userInfo: 2,
        hostname: 3,
        port: 4,
...
(function (a, e) {
    ...
    function d(a) {
        var b, c = "", d = "", i, h = [6, 9], f, p = n && n.createElement("div"), D = [], s = {
            webkit: e,
            trident: e,
            gecko: e,
            presto: e,
...
(function (a, e) {
    ...
    g.prototype = {
        constructor: g, notifyAll: function () {
            var b = this.fn;
